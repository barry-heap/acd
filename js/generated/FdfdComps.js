...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.FdfdComps || (root.FdfdComps = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (FdfdComps_, KaitaiStream) {
var FdfdComps = (function() {
  function FdfdComps(_io, _parent, _root, recordLength) {
    this._io = _io;
  ...
  FdfdComps.prototype._read = function() {
    this._raw_header = this._io.readBytes(155);
    var _io__raw_header = new KaitaiStream(this._raw_header);
    this.header = new Header(_io__raw_header, this, this._root);
    this.recordBuffer = this._io.readBytes((this.recordLength - 155) - 8);
  }

  var Header = FdfdComps.Header = (function() {
  ...
  var StrzUtf16 = FdfdComps.StrzUtf16 = (function() {
...
FdfdComps_.FdfdComps = FdfdComps;
});
