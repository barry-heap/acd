// Port of acd/l5x/catalog_numbers.py's CATALOG_NUMBERS table. Keyed by
// "vendor,productType,productCode" (matching PORT_STRUCTURES's key
// convention in this JS port).
const CATALOG_NUMBERS = new Map([
...
module.exports = { CATALOG_NUMBERS };
